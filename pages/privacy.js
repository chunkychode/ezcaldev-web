  ...
  return (
    <Layout>
      <div className="bg-white text-gray-900 p-5">
        ...
        <div className="m-1">
          EZCALDEV (“we” or “us” or “our”) respects the privacy of our users
          (“user” or “you”). This Privacy Policy explains how we collect, use,
          disclose, and safeguard your information when you visit our website
          ezcaldev.com, including any other media form, media channel, mobile
          ...
          date such revised Privacy Policy is posted. This privacy policy was
          created using Termly.
        </div>
        <h1 className="font-bold text-lg">COLLECTION OF YOUR INFORMATION</h1>
        <div className="m-1">
          We may collect information about you in a variety of ways. The
          information we may collect on the Site includes: <br></br>Personal
          Data Personally, identifiable information, such as your name, shipping
          ...
          such as online chat and message boards. You are under no obligation to
          ...
          access the Site, such as your IP address, your browser type, your
          operating system, your access times, and the pages you have viewed
          directly before and after accessing the Site. Financial Data Financial
          ...
          about our services from the Site. We store only very limited, if any,
          financial information that we collect. Otherwise, all financial
          information is stored by our payment processor, and you are encouraged
          to review their privacy policy and contact them directly for responses
          to your questions. Mobile Device Data Device information, such as your
          ...
          Data From Contests, Giveaways, and Surveys Personal and other
          information you may provide when entering contests or giveaways and/or
          responding to surveys.
        </div>
        <h1 className="font-bold text-lg">USE OF YOUR INFORMATION</h1>
        <div className="m-1">
          Having accurate information about you permits us to provide you with a
          smooth, efficient, and customized experience. Specifically, we may use
          information collected about you via the Site to: ● Assist law
          enforcement and respond to subpoena. ● Compile anonymous statistical
          data and analysis for use internally or with third parties. ● Create
          and manage your account. ● Deliver targeted advertising, coupons,
          newsletters, and other information regarding promotions and the Site
          to you. ● Email you regarding your account or order. ● Enable
          user-to-user communications. ● Fulfill and manage purchases, orders,
          payments, and other transactions related to the Site. ● Generate a
          personal profile about you to make future visits to the Site more
          personalized. ● Increase the efficiency and operation of the Site. ●
          Monitor and analyze usage and trends to improve your experience with
          the Site. ● Notify you of updates to the Site. ● Offer new products,
          services, and/or recommendations to you. ● Perform other business
          activities as needed. ● Prevent fraudulent transactions, monitor
          against theft, and protect against criminal activity. ● Process
          payments and refunds. ● Request feedback and contact you about your
          use of the Site. ● Resolve disputes and troubleshoot problems. ●
          Respond to product and customer service requests. ● Send you a
          newsletter. ● Solicit support for the Site.
        </div>
        <h1 className="font-bold text-lg">DISCLOSURE OF YOUR INFORMATION</h1>
        <div className="m-1">
          We may share information we have collected about you in certain
          situations. Your information may be disclosed as follows: By Law or to
          Protect Rights If we believe the release of information about you is
          ...
          protection and credit risk reduction. Third-Party Service Providers We
          ...
          assistance. Interactions with Other Users If you interact with other
          users of the Site, those users may see your name, profile photo, and
          ...
          to the Site, your posts may be viewed by all users and may be publicly
          distributed outside the Site [and our mobile application] in
          perpetuity. Third-Party Advertisers We may use third-party advertising
          companies to serve ads when you visit the Site. These companies may
          use information about your visits to the Site and other websites that
          are contained in web cookies in order to provide advertisements about
          goods and services of interest to you. Affiliates We may share your
          ...
          Third Parties We may share your information with advertisers and
          ...
          purposes, as permitted by law. Sale or Bankruptcy If we reorganize or
          sell all or a portion of our assets, undergo a merger, or are acquired
          by another entity, we may transfer your information to the successor
          entity. If we go out of business or enter bankruptcy, your information
          would be an asset transferred or acquired by a third party. You
          acknowledge that such transfers may occur and that the transferee may
        ...
        <h1 className="font-bold text-lg">TRACKING TECHNOLOGIES</h1>
        <div className="m-1">
          Cookies and Web Beacons We may use cookies, web beacons, tracking
          pixels, and other tracking technologies on the Site to help customize
          the Site and improve your experience. When you access the Site, your
          ...
          affect the availability and functionality of the Site. You may not
          ...
          decline cookies on an individual basis. We may use cookies, web
          beacons, tracking pixels, and other tracking technologies on the Site
          to help customize the Site and improve your experience. For more
          information on how we use cookies, please refer to our Cookie Policy
          posted on the Site, which is incorporated into this Privacy Policy. By
          using the Site, you agree to be bound by our Cookie Policy.
          Internet-Based Advertising Additionally, we may use third-party
          software to serve ads on the Site, implement email marketing
          campaigns, and manage other interactive marketing initiatives. This
          third-party software may use cookies or similar tracking technology to
          help manage and optimize your online experience with us. For more
          information about opting-out of interest-based ads, visit the Network
          ...
          third-party vendors[, such as Google Analytics and others, to allow
          ...
          things, analyze and track users’ use of the Site, determine the
          ...
          or Digital Advertising Alliance Opt-Out Tool. You should be aware that
        ...
        <h1 className="font-bold text-lg">THIRD-PARTY WEBSITES</h1>
        <div className="m-1">
        ...
        <h1 className="font-bold text-lg">SECURITY OF YOUR INFORMATION</h1>
        <div className="m-1">
        ...
        <h1 className="font-bold text-lg">POLICY FOR CHILDREN</h1>
        <div className="m-1">
        ...
        <div className="m-1">
          ...
          be retained in our files to prevent fraud, troubleshoot problems,
          assist with any investigations, enforce our Terms of Use and/or comply
          with legal requirements. Emails and Communications If you no longer
          wish to receive correspondence, emails, or other communications from
          us, you may opt-out by: ● Contacting us using the contact information
        ...
        <h1 className="font-bold text-lg">CALIFORNIA PRIVACY RIGHTS</h1>
        <div className="m-1">
